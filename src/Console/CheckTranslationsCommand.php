...
class CheckTranslationsCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'translations:check {lang} {--export-first}';
     ...
     * @param  \Goodmagma\Translations\Core\UntranslatedStringFinder  $finder
     * @return void
     */
    public function __construct(protected TranslationExporter $exporter, protected UntranslatedStringFinder $finder)
    {
        parent::__construct();
    }
